        ...
        <table className='w-full mx-auto'>
          <thead>
            <tr className='bg-primary bold-14 sm:regular-22 text-start py-12'>
              <th className='p-2 py-2'>Products</th>
              <th className='p-2 py-2'>Title</th>
              <th className='p-2 py-2'>Old Price</th>
              <th className='p-2 py-2'>New Price</th>
              <th className='p-2 py-2'>Category</th>
              <th className='p-2 py-2'>Remove</th>
            </tr>
          </thead>
          <tbody>
            {allproducts.map((product,i)=>(
               <tr key={i} className='border-b border-slate-900/20 text-gray-20 p-6 medium-14'>
                  <td className='flexStart sm:flexCenter'>
                    <img src={product.image}  width={43} height={43} className='rounded-lg ring-1 ring-slate-900/5 my-1'/>
                  </td>
