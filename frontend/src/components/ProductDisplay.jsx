    ...
    <div className='flex flex-col gap-14 xl:flex-row'>
        <div  className='flex gap-x-2 xl:flex-1'>
            <div className='flex flex-col gap-[7px] flex-wrap'>
               <img src={product_rt_1} alt="prdc" className='max-h-[99px]' /> 
               <img src={product_rt_2} alt="prdc" className='max-h-[99px]' /> 
               <img src={product_rt_3} alt="prdc" className='max-h-[99px]' /> 
               <img src={product_rt_4} alt="prdc" className='max-h-[99px]' /> 
            </div>
            <div>
        ...
        <div className='flex-col flex xl:flex-[1.7]'>
            ...
            <div className='mb-4'>
                ...
                <p><span className='medium-16 text-tertiary'>Tags:</span>Modern|Latest|Winter</p>
            </div>
        </div>
