      ...
      <section className='max_padd_container pt-28'>
                        ...
                        if (cartItems[e.id]>0) {
                            return <tr key={e.id} className='border-b border-slate-900/20 p-6 medium-14 text-center text-gray-30'>
                                <td className='flexCenter' >
                                    <img src={e.image} height={43} width={43} className='rounded-lg ring-1 ring-slate-900/5 my-1'/>
                                </td>
                                <td>
                                ...
                                <td><div className='bold-22 pl-14'> <TbTrash onClick={()=>removeFromCart(e.id)}/>
                                    </div>
                                    </td>
                            </tr>
                        }
        ...
        <div className='flex flex-col gap-20 my-16 p-8 md:flex-row rounded-md bg-white w-full max-w-[666px]'>
            <div className='flex flex-col gap-10'>
                ...
                <div>
                    <div className=' flexBetweeen py-4'>
